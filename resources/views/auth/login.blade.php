...
<div class="min-h-[85vh] flex items-center justify-center p-6 bg-secondary/20 relative overflow-hidden">
    ...
    <div class="absolute bottom-0 left-0 w-96 h-96 bg-primary/20 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"></div>
    ...
    <div class="w-full max-w-[420px] relative z-10">
        ...
        <div class="text-center mb-10">
            ...
            <p class="text-[15px] opacity-70">Log in securely to manage your appointments.</p>
        </div>
        ...
        <div class="bg-white p-8 sm:p-10 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-secondary">
            ...
            <div class="relative flex items-center justify-center mb-8">
                ...
                <div class="absolute bg-white px-5 text-xs font-bold uppercase text-text-main/40 uppercase tracking-widest">Or login with email</div>
            </div>
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" class="w-full px-5 py-3.5 bg-secondary/30 border border-secondary rounded-xl focus:bg-white focus:border-primary transition-all text-sm outline-none" placeholder="you@example.com" required>
                </div>
                
                <div x-data="{ show: false }">
                    <div class="flex justify-between items-center mb-2">
                        <label for="password" class="block text-sm font-semibold opacity-90">Password</label>
                        <a href="/forgot-password" class="text-xs text-cta hover:text-cta-hover font-semibold transition-colors">Forgot?</a>
                    </div>
                    <div class="relative">
        ...
        <div class="mt-8 text-center space-y-4">
            <p class="text-sm font-medium opacity-90">
                Don't have an account? <a href="/register" class="text-cta hover:text-cta-hover font-bold transition-colors">Sign up</a>
            </p>
            <p class="text-xs opacity-60 flex items-center justify-center gap-1.5 pt-4 border-t border-secondary/50 max-w-[250px] mx-auto">
                <svg class="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
