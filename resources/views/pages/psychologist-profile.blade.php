    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-8 md:p-10 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col relative h-full hover:shadow-md transition-shadow">
                ...
                <p class="opacity-80 leading-relaxed mb-8 flex-grow italic mt-2">"Clara really listens. I felt completely validated and heard without judgment. The CBT techniques she provided have genuinely changed how I approach my daily anxiety."</p>
                <div class="flex items-center gap-4 pt-6 border-t border-slate-100">
                    <div class="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center font-black text-text-main shadow-sm">M</div>
                    <div>
                        <p class="font-bold">M. A.</p>
            ...
            <div class="bg-white p-8 md:p-10 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col relative h-full hover:shadow-md transition-shadow">
                ...
                <p class="opacity-80 leading-relaxed mb-8 flex-grow italic mt-2">"I was so nervous for my first session, but she has such a warm, empathetic presence. Within 10 minutes I felt like I was talking to an old friend who actually understands psychology."</p>
                <div class="flex items-center gap-4 pt-6 border-t border-slate-100">
                    <div class="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center font-black text-text-main shadow-sm">S</div>
                    <div>
                        <p class="font-bold">S. K.</p>
                        <p class="text-xs font-semibold opacity-50 uppercase tracking-widest mt-0.5">Verified Client</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Review 3 -->
            <div class="bg-white p-8 md:p-10 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col relative h-full md:col-span-2 lg:col-span-1 hover:shadow-md transition-shadow">
                <div class="text-6xl text-primary/30 absolute top-6 right-8 font-serif leading-none">"</div>
                <div class="flex text-yellow-400 mb-6 gap-0.5">
                    @for($i=0; $i<5; $i++)
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                ...
                <p class="opacity-80 leading-relaxed mb-8 flex-grow italic mt-2">"Finally found a therapist who I resonate with. Her focus on safe spaces is real. I never felt rushed during my sessions and she genuinely cares."</p>
                <div class="flex items-center gap-4 pt-6 border-t border-slate-100">
                    <div class="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center font-black text-text-main shadow-sm">D</div>
                    <div>
                        <p class="font-bold">D. N.</p>
                        <p class="text-xs font-semibold opacity-50 uppercase tracking-widest mt-0.5">Verified Client</p>
                    </div>
                </div>
            </div>
