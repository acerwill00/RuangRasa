...
<section class="py-24 bg-slate-50 min-h-[80vh]">
    <div class="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
            <h1 class="text-4xl md:text-5xl font-bold mb-6 text-text-main">{{ __('Get in Touch') }}</h1>
            <p class="opacity-80 text-lg mb-12 leading-relaxed max-w-lg">{{ __('Whether you have questions about our booking process or need help picking the perfectly aligned psychologist, our empathetic support team is ready to guide you.') }}</p>
        ...
        <div class="bg-white p-8 md:p-12 rounded-[2rem] shadow-soft border border-primary/20 relative">
            ...
            <h3 class="text-3xl font-bold mb-8">{{ __('Send a Message') }}</h3>
            
            <form action="#" class="space-y-6">
                <div>
                    <label class="block text-sm font-bold text-text-main mb-2">{{ __('Your Name') }}</label>
                ...
                <div>
                    <label class="block text-sm font-bold text-text-main mb-2">{{ __('Email Address') }}</label>
                ...
                <div>
                    <label class="block text-sm font-bold text-text-main mb-2">{{ __('Message') }}</label>
